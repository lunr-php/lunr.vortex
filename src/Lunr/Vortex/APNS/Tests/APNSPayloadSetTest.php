...
class APNSPayloadSetTest extends APNSPayloadTest
{
    ...
    {
        $this->class->set_priority(APNSPriority::Normal);

        $value = $this->get_reflection_property_value('elements');

        $this->assertArrayHasKey('priority', $value);
        $this->assertEquals(APNSPriority::Normal, $value['priority']);
    }
    ...
    {
        $this->assertSame($this->class, $this->class->set_priority(APNSPriority::Normal));
    }
